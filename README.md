...
1. Clone repo, change directory to /react-exercise, and enter "npm i".
2. Open a new terminal, change directory to /react-exercise/client and enter "npm i".
3. In the first terminal, enter "npm start".
4. In the client terminal, enter "npm start".
5. A new window should pop up with the application. Enjoy!
